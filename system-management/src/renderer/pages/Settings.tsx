...
const ActionButtons = () => (
    <div style={{ marginTop: '20px', marginBottom: '20px' }}>
        <button
            ...
            style={{ ...ButtonStyle, backgroundColor: '#10a37f', marginLeft: 0, boxShadow: '0 2px 10px rgba(16, 163, 127, 0.3)' }}
        >
        ...
        <button
            ...
            style={{ ...ButtonStyle, backgroundColor: '#4285f4', boxShadow: '0 2px 10px rgba(66, 133, 244, 0.3)' }}
        >
        ...
        <button
            ...
            style={{ ...ButtonStyle, backgroundColor: '#10b981', boxShadow: '0 2px 10px rgba(16, 185, 129, 0.3)' }}
        >
        ...
        <button
            ...
            style={{ ...ButtonStyle, backgroundColor: '#6366f1', boxShadow: '0 2px 10px rgba(99, 102, 241, 0.3)' }}
        >
